...
public class EventManager : ICollection<IEvent>
{
    ...
    public static EventManager operator +(EventManager e, IEvent item)
    {
        e.Add(item);
        return e;
    }
    
    public static EventManager operator ++(EventManager e)
    {
        e.Add(new SingleEvent());
        return e;
    }
    
    public static EventManager operator <<(EventManager e, int index)
    {
